...
${PARENT_PATH}/unimog_to_ilp.py -i ${PARENT_PATH}/${UNIMOG_FILE_NAME}.unimog -u ${PARENT_PATH}/${UNIMOG_FILE_NAME}.ids -o ${PARENT_PATH}/${UNIMOG_FILE_NAME}.lp 2> /dev/null

gurobi_cl ResultFile=${PARENT_PATH}/${UNIMOG_FILE_NAME}.sol ${PARENT_PATH}/${UNIMOG_FILE_NAME}.lp > /dev/null
